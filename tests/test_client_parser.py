...
class TestClientParser(unittest.TestCase):
    def test_get_einvoice_client_data(self):
        m_cn_id = "5208214"
        clients_data, supplier = get_einvoice_client_data(m_cn_id=m_cn_id, xml_text=xml_text_from_xml)
    ...
    def test_get_einvoice_client_data_none(self):
        m_cn_id = "5208215"
        clients_data, supplier = get_einvoice_client_data(m_cn_id=m_cn_id, xml_text=xml_text_none)
    ...
    def test_get_einvoice_client_data_all_data(self):
        m_cn_id = "5207492"
        clients_data, supplier = get_einvoice_client_data(m_cn_id=m_cn_id, xml_text=xml_text_from_zugpferd)
        self.assertEqual(clients_data,
