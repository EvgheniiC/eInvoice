...
- [ ] Квоты: число parse/export в сутки, размер файла (гость 10 MB → Plus выше), параллелизм.
- [ ] Отдельный rate limit для гостя и для аккаунта.
- [ ] Понятное немецкое сообщение при исчерпании лимита + CTA на Plus.
...
1. [ ] Лимиты по плану (гость / plus / team) на parse и export (A5).
