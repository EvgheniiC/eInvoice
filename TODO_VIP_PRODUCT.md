...
- [ ] Batch upload и пакетная обработка нескольких счетов.
      (`TODO_SUBSCRIPTION.md` A1, этап 2)
- [ ] История последних операций только при явном согласии пользователя.
      (`TODO_SUBSCRIPTION.md` A2; оригинал файла — opt-in + retention)
- [ ] Поиск дублей по номеру, продавцу, дате и сумме.
      (`TODO_SUBSCRIPTION.md` A3)
- [ ] Экспорт нескольких счетов одним бухгалтерским пакетом.
