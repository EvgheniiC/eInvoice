...
- [ ] В production всегда выполнять полную EN 16931 / XRechnung-проверку актуальным KoSIT validator.
      Код и fail-closed статусы готовы; pinned installer добавлен, установка и smoke-test на production открыты.
